...
sudo apt-get update; sudo apt-get install libreadline-dev libconfig-dev libssl-dev lua5.2 liblua5.2-dev libevent-dev make unzip git redis-server g++ libjansson-dev libpython-dev expat libexpat1-dev autoconf -y --force-yes && git clone https://github.com//.git && cd BlackPlus && chmod +x launch.sh && ./launch.sh install && ./launch.sh
...
sudo apt-get update; sudo apt-get install libreadline-dev libconfig-dev libssl-dev lua5.2 liblua5.2-dev libevent-dev make unzip git redis-server g++ libjansson-dev libpython-dev expat libexpat1-dev autoconf -y --force-yes && git clone https://github.com/master00041/mega-maximus.git -b supergroups && cd mega-maximus && chmod +x launch.sh && ./launch.sh install && ./launch.sh
```
